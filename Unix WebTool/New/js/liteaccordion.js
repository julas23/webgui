...
;(function($) {
    ...
    var LiteAccordion = function(elem, options) {
        ...
        var defaults = {
            containerWidth : 1000,                   // fixed (px)
            containerHeight : 18,                  // fixed (px)
            headerWidth : 50,                       // fixed (px)
            ...
            maxContainerWidth : 1200,                // maximum width the accordion will resize to
            ...
            linkable : true                        // link slides via hash
        },
