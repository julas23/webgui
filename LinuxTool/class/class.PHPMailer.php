...
class PHPMailer
{
     ...
     * @var string
     */
    public $From = 'root@192.168.0.254';
     ...
     * Returns '192.168.0.254.localdomain' if unknown.
     *
     * @return string
     */
    protected function serverHostname()
    {
        ...
        if (!static::isValidHost($result)) {
            return '192.168.0.254.localdomain';
        }
